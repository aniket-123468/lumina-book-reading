      ...
      <main className="relative z-20 flex-grow flex items-center justify-center p-margin-mobile md:p-0">
        ...
        <section className="w-full max-w-md bg-[#F5F1EA] border border-[#5C4033]/10 rounded-xl shadow-2xl overflow-hidden flex flex-col items-center py-12 px-8 md:px-10">
          ...
          <header className="text-center mb-stack-lg">
            ...
            <p className="font-label-sm text-label-sm text-secondary uppercase tracking-widest">Join the Scribes</p>
          </header>
          ...
          <form className="w-full flex flex-col gap-stack-md" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col gap-1 group">
              <label className="font-label-sm text-label-sm text-on-surface-variant px-1 group-focus-within:text-tertiary transition-colors" htmlFor="name">Full Name</label>
              <input 
            ...
            <button 
              ...
              disabled={isLoading}
            >
              <span>{isLoading ? 'Creating...' : 'Create Library'}</span>
              <span className="material-symbols-outlined text-[18px] group-hover/btn:translate-x-1 transition-transform">auto_stories</span>
            </button>
          </form>
          ...
          <footer className="mt-stack-lg text-center">
            <p className="font-body-md text-body-md text-secondary">
              ...
              <Link className="text-tertiary font-semibold hover:underline decoration-tertiary/30 underline-offset-4 ml-1" to="/login">Sign In</Link>
            </p>
          </footer>
        </section>
      </main>
